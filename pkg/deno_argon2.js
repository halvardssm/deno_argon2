...
export function hash(password, algo, params) {
    try {
        ...
        _assertClass(params, Params);
        var ptr1 = params.ptr;
        params.ptr = 0;
        wasm.hash(retptr, ptr0, len0, algo, ptr1);
...
* @returns {string}
*/
export function hash_default(password) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.hash_default(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('deno_argon2_bg.wasm', import.meta.url);
    }
    const imports = getImports();
